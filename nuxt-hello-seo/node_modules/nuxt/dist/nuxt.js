...
var waitFor = function () {
  var _ref = asyncToGenerator(index$2.mark(function _callee(ms) {
    return index$2.wrap(function _callee$(_context) {
      while (1) {
...
var ModuleContainer = function (_Tapable) {
  ...
  createClass(ModuleContainer, [{
    key: '_ready',
    value: function () {
      var _ref = asyncToGenerator(index$2.mark(function _callee() {
        return index$2.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    key: 'addModule',
    value: function () {
      var _ref2 = asyncToGenerator(index$2.mark(function _callee2(moduleOpts, requireOnce) {
        var _this2 = this;

        var options, originalSrc, module, alreadyRequired;
        return index$2.wrap(function _callee2$(_context2) {
          while (1) {
...
var Renderer = function (_Tapable) {
  ...
  createClass(Renderer, [{
    ...
    key: 'loadResources',
    value: function () {
      var _ref2 = asyncToGenerator(index$2.mark(function _callee2() {
        var _this2 = this;

        var _fs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : fs$1__default;

        var distPath, updated, errorTemplatePath;
        return index$2.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    key: 'setupMiddleware',
    value: function () {
      var _ref4 = asyncToGenerator(index$2.mark(function _callee4() {
        var _this3 = this;

        var distDir;
        return index$2.wrap(function _callee4$(_context4) {
          while (1) {
              ...
              case 2:
                ...
                if (this.options.dev) {
                  this.useMiddleware(function () {
                    var _ref5 = asyncToGenerator(index$2.mark(function _callee3(req, res, next) {
                      return index$2.wrap(function _callee3$(_context3) {
                        while (1) {
    ...
    key: 'nuxtMiddleware',
    value: function () {
      var _ref6 = asyncToGenerator(index$2.mark(function _callee5(req, res, next) {
        var context, _ref7, html, error, redirected, resourceHints, etag, regex, pushAssets, m, _m, _m2, _2, rel, href, as;

        return index$2.wrap(function _callee5$(_context5) {
          while (1) {
    ...
    key: 'readSource',
    value: function () {
      var _ref8 = asyncToGenerator(index$2.mark(function _callee6(frame) {
        ...
        return index$2.wrap(function _callee6$(_context6) {
          while (1) {
    ...
    key: 'renderRoute',
    value: function () {
      var _ref9 = asyncToGenerator(index$2.mark(function _callee7(url) {
        var _this5 = this;

        var context = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

        var SPAData, data, _html, APP, m, HEAD, resourceHints, html;

        return index$2.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 2:
                ...
                SPAData = context.spa || context.res && context.res.spa;
    ...
    value: function () {
      var _ref10 = asyncToGenerator(index$2.mark(function _callee8(url) {
        var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

        var options, _ref11, window, nuxtExists, error;

        return index$2.wrap(function _callee8$(_context8) {
          while (1) {
...
var Nuxt = function (_Tapable) {
  ...
  createClass(Nuxt, [{
    ...
    key: 'close',
    value: function () {
      var _ref2 = asyncToGenerator(index$2.mark(function _callee2(callback) {
        return index$2.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
...
var Builder = function (_Tapable) {
  ...
  createClass(Builder, [{
    ...
    value: function () {
      var _ref2 = asyncToGenerator(index$2.mark(function _callee3() {
        var _this3 = this;
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 32:
                ...
                return Promise.all(templatesFiles.map(function () {
                  var _ref3 = asyncToGenerator(index$2.mark(function _callee2(_ref4) {
                    var src = _ref4.src,
                        dst = _ref4.dst,
    ...
    key: 'webpackBuild',
    value: function () {
      var _ref5 = asyncToGenerator(index$2.mark(function _callee5() {
        var _this4 = this;
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                this.compiler.plugin('done', function () {
                  var _ref6 = asyncToGenerator(index$2.mark(function _callee4(stats) {
                    return index$2.wrap(function _callee4$(_context4) {
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                  ...
                  return new Promise(function (resolve$$1, reject) {
                    if (_this4.options.dev) {
                      ...
                      compiler.run(function (err, stats) {
                        ...
                        var hiddenAssets = [/.map$/, /index\..+\.html$/, /vue-ssr-client-manifest.json/];
                        var statsJson = stats.toJson(_this4.webpackStats, true);
                        statsJson.assets = statsJson.assets.filter(function (asset) {
                          return hiddenAssets.every(function (e) {
                            return !e.test(asset.name);
                          });
                        });
...
var Generator = function (_Tapable) {
  ...
  createClass(Generator, [{
    key: 'generate',
    value: function () {
      var _ref = asyncToGenerator(index$2.mark(function _callee2() {
        var _this2 = this;
        ...
        return index$2.wrap(function _callee2$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                s = Date.now();
              ...
              case 32:
                _loop = index$2.mark(function _loop() {
                  var n;
                  return index$2.wrap(function _loop$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          n = 0;
                          ...
                          return Promise.all(routes.splice(0, _this2.options.generate.concurrency).map(function () {
                            var _ref4 = asyncToGenerator(index$2.mark(function _callee(_ref5) {
    ...
    key: 'initDist',
    value: function () {
      var _ref6 = asyncToGenerator(index$2.mark(function _callee3() {
        var nojekyllPath;
        return index$2.wrap(function _callee3$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
    ...
    key: 'generateRoute',
    value: function () {
      var _ref7 = asyncToGenerator(index$2.mark(function _callee4(_ref8) {
        ...
        return index$2.wrap(function _callee4$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                html = void 0;
